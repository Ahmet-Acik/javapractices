package org.ahmet.optional_Impl;
    ...
    public class OptionalImplement {
        public static void main(String[] args) {
            ...
            // Example of using Optional with orElseGet
            String orElseGetValue = Optional.ofNullable(value).orElseGet(() -> "Generated Default Value");
            System.out.println("orElseGet value: " + orElseGetValue); // Output: Generated Default Value

            // Example of using Optional with orElseThrow and custom exception
            try {
                String resultOrThrowCustom = Optional.ofNullable(value)
                        .orElseThrow(() -> new CustomException("Custom exception: Value cannot be null"));
            } catch (CustomException e) {
                System.out.println(e.getMessage()); // Output: Custom exception: Value cannot be null
            }
        }
